...
<style>
    ...
    /* ============================================
       PRODUCT CARDS - FIXED IMAGE CONTAINER
    ============================================ */
    .product-grid {
        display: grid;
        grid-template-columns: repeat(4, 1fr);
    ...
    .deal-card-modern:hover .deal-icon {
        background: var(--accent);
        color: var(--white);
        transform: scale(1.1);
    }

    .deal-card-modern .deal-title {
        font-weight: 700;
        font-size: 1rem;
        color: var(--dark);
        margin-bottom: 4px;
...
<section class="py-5">
    <div class="container">
        <div class="section-header-modern">
            <h2 class="section-title-modern">
                <i class="fa-solid fa-tag"></i> Today's Best Deals
            </h2>
        </div>
        <div class="deals-grid">
            <div class="deal-card-modern">
                <div class="deal-icon"><i class="fa-solid fa-percent"></i></div>
                <div class="deal-title">Up to 50% Off</div>
                <div class="deal-desc">On selected electronics</div>
            </div>
            <div class="deal-card-modern">
                <div class="deal-icon"><i class="fa-solid fa-gift"></i></div>
                <div class="deal-title">Buy 1 Get 1 Free</div>
                <div class="deal-desc">On fashion items</div>
            </div>
            <div class="deal-card-modern">
                <div class="deal-icon"><i class="fa-solid fa-truck-fast"></i></div>
                <div class="deal-title">Free Shipping</div>
                <div class="deal-desc">On orders over KSH 5,000</div>
            </div>
            <div class="deal-card-modern">
                <div class="deal-icon"><i class="fa-solid fa-star"></i></div>
                <div class="deal-title">Earn Rewards</div>
                <div class="deal-desc">20% back on every purchase</div>
            </div>
        </div>
    </div>
</section>
